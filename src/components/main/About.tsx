...
import { ArrowLeft, Github, Mail, BookOpen, Lightbulb, AlertCircle, Quote } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold tracking-tight">About Semantic Highlighter</h1>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Intelligent text analysis and highlighting tool powered by advanced semantic understanding
        </p>
      </div>
      ...
      <div className="grid gap-12">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed text-lg">
            ...
            and action items using advanced pattern recognition algorithms.
          </p>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="group p-6 bg-blue-50 rounded-xl border border-blue-200 hover:shadow-lg transition-all duration-200 hover:-translate-y-1">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-semibold text-blue-900">Definitions</h3>
              </div>
              <p className="text-blue-800">Automatically identifies and highlights definitions, explanations, and key concepts in your text</p>
            </div>
            ...
            <div className="group p-6 bg-green-50 rounded-xl border border-green-200 hover:shadow-lg transition-all duration-200 hover:-translate-y-1">
              ...
              <p className="text-green-800">Finds examples and illustrations that support main concepts and help clarify complex ideas</p>
            </div>
            ...
            <div className="group p-6 bg-yellow-50 rounded-xl border border-yellow-200 hover:shadow-lg transition-all duration-200 hover:-translate-y-1">
              ...
              <p className="text-yellow-800">Identifies TODOs, tasks, action items, and other actionable content in your text</p>
            </div>
            ...
            <div className="group p-6 bg-purple-50 rounded-xl border border-purple-200 hover:shadow-lg transition-all duration-200 hover:-translate-y-1">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-semibold text-purple-900">Quotes & References</h3>
              </div>
              <p className="text-purple-800">Highlights important quotes, citations, and references from authoritative sources</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid gap-4">
            <div className="flex items-start space-x-4 p-4 bg-muted/30 rounded-lg">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Paste or type your text into the rich text editor. You can also try our sample text to see how it works.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 p-4 bg-muted/30 rounded-lg">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Press the "Analyze Text" button to process your content using our advanced semantic analysis engine.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 p-4 bg-muted/30 rounded-lg">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Review the color-coded highlights in your text, with each category clearly marked and explained.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 p-4 bg-muted/30 rounded-lg">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Use the pill toggles to show or hide different highlight categories based on your needs.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="p-6 bg-muted/30 rounded-xl border">
            <p className="text-muted-foreground leading-relaxed">
              Built with modern web technologies including <strong>React</strong>, <strong>TypeScript</strong>, 
              <strong>Tailwind CSS</strong>, and <strong>Firebase Authentication</strong>. 
              The semantic analysis is powered by advanced pattern recognition algorithms that identify 
              contextual clues and linguistic patterns in your text. The rich text editor is built with 
        ...
        <section className="text-center space-y-6 py-8">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Try our semantic highlighter today and discover insights hidden in your text!
          </p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          <div className="text-center md:text-left">
            <p className="text-sm text-muted-foreground">
              <strong>Semantic Highlighter v1.0.0</strong> • Built by <strong>BuildScraps</strong>
            </p>
          ...
          <div className="flex space-x-4">
            <Button 
              variant="ghost" 
              size="sm"
              onClick={() => window.open('mailto:contact@buildscraps.com', '_blank')}
            >
